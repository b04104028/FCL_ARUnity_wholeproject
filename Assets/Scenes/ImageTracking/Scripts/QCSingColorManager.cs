...
public class QCSingColorManager : MonoBehaviour
{
    ...
    public void Start()
    {
        string path = Application.persistentDataPath + "/PersistantFilePath/" + "Sing_QC_total.json";//"ExampleJSON.json";
    ...
    public void AssignColor()
    {
        ...
        //{
            ...
            {
                case <= 0.2f:
                    rend.material.color = Color.Lerp(Color.white, Color.blue, (float)(lerp / 0.2f));
                    break;
                case <= 1.0f:
                    rend.material.color = Color.Lerp(Color.blue, Color.black, (float)((lerp - 0.2f) / 0.8f));
                    break;
                case > 1.0f:
