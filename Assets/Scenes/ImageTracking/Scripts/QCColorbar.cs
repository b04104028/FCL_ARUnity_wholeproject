...
public class QCColorbar : MonoBehaviour
{
    public List<GameObject> colorbarlist = new List<GameObject>();
    [SerializeField] public QCColorManager _qccolormanager;
    ...
    {
        SetColorbar();
        double maxloadrounded = RoundToNearest(_qccolormanager.max_load);
